                ...
                <Block>
                    ...
                    >
                        ...
                        <div className="text-start">
                            ...
                            "Яндекс.Контест" на дистанционном этапе
                            Олимпиады.
                            <br></br>
                            Проверьте, что учетная запись является действующей,
                            участник знает пароль и в случае необходимости сможет использовать ее во
                ...
                <Block>
                    <div className="flex row gap-1">
                        ...
                        <div className="text-s">
                            ...
                            пароль и в случае необходимости сможет использовать ее во время Олимпиады
                        </div>
                    </div>
                </Block>
                <Block>
